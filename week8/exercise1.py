...
def fizz_buzz():
    ...
    # your code here
    fizzBuzzList = ["Fizz"*(not i%3) + "Buzz"*(not i%5) or i for i in range(1, 101)]
    return fizzBuzzList
...
def pet_filter(letter="a"):
    ...
    pets = [
            ...
            "hedgehog","guppy",]
    # fmt: on
    words=[word for word in pets if letter in word]
    return words
...
def fast_filler(number_of_words=200):
    ...
    fastdict = make_filler_text_dictionary
    stringpara = []
